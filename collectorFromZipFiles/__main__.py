...
urlPollution = ["http://iot.ee.surrey.ac.uk:8080/datasets/pollution/citypulse_pollution_csv_data_aarhus_aug_oct_2014.tar.gz"]

# client = Minio("172.17.0.2:9000","minio99","minio123",secure=False)
client = Minio("172.17.0.2:9000",access_key="xisTpFY0vvQp6bC4",secret_key="RvAMmKhMprRDce1KbK2gxZdTjnWLo9pm",secure=False)

# client = Minio("127.0.0.1:9000","minio99","minio123",secure=False)
